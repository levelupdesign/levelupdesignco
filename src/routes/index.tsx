  ...
  return (
    <section className="border-b border-border">
      <div className="mx-auto max-w-5xl px-5 py-10">
        <div className="max-w-2xl">
          <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-brand">Servicios clave</div>
          <h2 className="mt-1.5 font-serif text-2xl md:text-3xl text-ink">Cómo podemos ayudarte</h2>
        </div>
        <div className="mt-5 grid md:grid-cols-3 gap-3">
          {cards.map(({ icon: Icon, title, desc, cta, to }) => (
            <div key={title} className="flex flex-col p-5 rounded-xl border border-border bg-background hover:border-brand/40 hover:shadow-[0_8px_20px_-12px_rgba(123,30,43,0.25)] transition-all">
              ...
              <p className="mt-1.5 text-sm text-ink-soft leading-snug flex-1">{desc}</p>
              <Link
                to={to}
