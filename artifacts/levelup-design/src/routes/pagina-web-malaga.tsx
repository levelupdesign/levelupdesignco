...
export const Route = createFileRoute("/pagina-web-malaga")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Diseño y desarrollo de páginas web profesionales en Málaga para empresas que necesitan presencia online moderna y orientada a captar clientes." },
      { property: "og:title", content: "Diseño web profesional en Málaga" },
      { property: "og:description", content: "Webs modernas, claras y orientadas a convertir visitas en oportunidades de negocio." },
    ],
  }),
  component: Page,
});
